...
class MagicString{
    ...
    //right here where we are going to write our own API
    ...
    //these are the API that will call String class
    public int length() {
...
public class DemoDecorator {
    public static void main(String[] args) {
        MagicString magicString = new MagicString("asdfghjklqwertyuiopzxcvbnm");
